        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative">
            <input 
              ...
              className="pl-10 pr-4 py-2.5 bg-white border border-slate-200 rounded-xl text-sm focus:ring-2 focus:ring-emerald-500/20 focus:border-[#10B981] outline-none w-48 shadow-sm"
            />
          ...
          <button 
            ...
            className="px-5 py-2.5 bg-[#10B981] text-white rounded-xl text-sm font-semibold hover:bg-[#064E3B] shadow-md shadow-emerald-200 transition-all text-nowrap"
          >
            + {t('addNew')}
          </button>
        </div>
