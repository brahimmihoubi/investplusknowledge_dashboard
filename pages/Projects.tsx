  ...
  return (
    <div className="space-y-6 animate-in slide-in-from-bottom-4 duration-500">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-slate-800">{t('investmentProjects')}</h1>
          <p className="text-slate-500 text-sm">{t('projectsSubtitle')}</p>
        </div>
      ...
      {isAdding && (
         <div className="bg-white p-6 rounded-3xl shadow-sm border border-slate-100 mb-6 animate-in fade-in duration-300">
           <h2 className="text-lg font-bold text-slate-800 mb-4">{editingId ? t('editProject') : t('addProject')}</h2>
           ...
           <div className="flex justify-end gap-3 mt-6">
               ...
               >
                 {editingId ? t('updateProject') : t('saveProject')}
               </button>
           </div>
         </div>
      )}
          ...
          <table className="w-full text-left">
            <thead>
              <tr className="bg-slate-50 text-slate-400 text-[11px] uppercase tracking-wider font-bold">
                ...
                <th className="px-6 py-4">{t('budget')}</th>
